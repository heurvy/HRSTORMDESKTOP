...
public class ResetPasswordMail {
    public static void sendMail(User u) throws Exception {
        ResetPasswordRandomCodeGenerator rs =new ResetPasswordRandomCodeGenerator(8);
        Config.setVerificationCode(rs.getSymbols().toString());
        String mailContent = "<!DOCTYPE html>\n"
                ...
                + "																							TO\n"
                + "																							MASTERHR</span></span></strong></span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                ...
                + "																							style=\"color:#2190e3;font-size:34px;\">"+u.getNom()+u.getPrenom()+"</span></span></strong></span>\n"
                + "																		</p>\n"
                + "																	</div>\n"
                + "																</div>\n"
                + "															</td>\n"
                ...
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\">You are trying to reset your password.<br>\n"
                + "																				Please enter the code below to re-create a new password</span></p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			</p>\n"
                + "																		<p\n"
                ...
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br> Code : <br>"+Config.getVerificationCode()+"<br></span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br><br>Requested\n"
                + "																				by : "+u.getEmail()+"</span></p>\n"
                + "																		<p\n"
                ...
                + "\n"
                + "</html>";
        String myAccountEmail = Config.getMail();
        ...
        Message message = prepareMessage(session, myAccountEmail, u.getEmail() , mailContent);
