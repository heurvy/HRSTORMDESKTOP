...
import COM.HRSTORMDESKTOP.chatwindow.ChatController;
import COM.HRSTORMDESKTOP.chatwindow.Listener;
import COM.HRSTORMDESKTOP.util.ResizeHelper;
...
public class LoginController implements Initializable {
    ...
    public void loginButtonAction() throws IOException {
        ...
        FXMLLoader fmxlLoader = new FXMLLoader(getClass().getResource("/chatviews/ChatView.fxml"));
